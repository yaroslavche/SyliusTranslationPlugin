...
namespace Tests\Yaroslavche\SyliusTranslationPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Yaroslavche\SyliusTranslationPlugin\Behat\Page\Shop\WelcomePageInterface;
